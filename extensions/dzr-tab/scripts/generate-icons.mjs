...
function iconSvg(size) {
  ...
  <g transform="translate(${padding}, ${padding}) scale(${scale.toFixed(4)})">
    <path d="${DEEZER_PATH}" fill="#a238ff"/>
  </g>
</svg>`;
}
